...
<body>
    ...
    <script>
        ...
        let questionList = [
            {
                question: "Like PHP echo this PHP is also a language construct, so you don’t need to use parenthesis with the argument list.",
                a: "PHP Print",
                b: "PHP echo",
                c: "document.write",
                d: "cout>>",
            ...
            {
                question: "In PHP, echo, ECHO, eChO are allowed, PHP is not ____ ________ language",
                a: "lower case",
                b: "Upper case",
                c: "Case sensitive",
                d: "Sensitive case",
            ...
            {
                question: "Do the echo statement will display output even without parenthesis?",
                a: "Yes",
                b: "No",
                c: "Maybe yes",
                d: "Maybe no",
            ...
            {
                question: "What value does echo returns?",
                a: "echo do not return values",
                b: "1 value",
                c: "2 or more values",
                d: "Many values",
                level: "easy",
                answer: "echo do not return values"
            },
            {
                question: "We can pass multiple strings separated by a comma (,) in echo.",
                a: "Maybe true",
                b: "True",
                c: "Maybe false",
                d: "False",
            ...
            {
                question: "print does not returns an integer value, which is 1.",
                a: "Maybe true",
                b: "True",
                c: "Maybe false",
                d: "False",
            ...
            {
                question: "How can you seperate values in PHP?",
                a: "period",
                b: "colon",
                c: "greater than sign",
                d: "comma",
            ...
            {
                question: "Where you should you type your PHP code?",
                a: "Inside HTML tags",
                b: "Outside HTML tags",
                c: "Inside PHP tags",
                d: "Outside PHP tags",
                level: "hard",
                answer: "Inside PHP tags"
            },
            {
                question: "echo is slower than the print statement.",
                a: "False",
                b: "True",
                c: "Maybe true",
                d: "Maybe false",
        ...
        function showForm() {
            ...
            document.getElementById('week').value = "7"
