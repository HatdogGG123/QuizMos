...
<script>
    ...
    const words = ['javascript', 'mosaic', 'classes', 'netsacpe', 'mongodb', 'sensitive', 'html', 'mocha', 'marc andreesen', 'brendan eich'];
    const question = [
        "A programming language used for scripting dynamic websites.",
        "It is the first popular web browser.",
        "JavaScript is an object-oriented programming language that uses prototypes rather than using ______ for inheritance.",
        "What web browser uses Javascript to script webpages in 1995?",
        
        "Databases such as CouchDB and ______ uses JavaScript as their scripting and query language.",
        "x and X is different variable name so Javascript is a case _________ language",
        "Javascript adds interactivity on websites when applied in an ____ document.",
        
        "What is the name of the first javascript code?",
        "He created the first javascript code.",
        "The company recruited __________ to implement and embed Schemed programming language on browsers."
    ]
