...
<script>
    ...
    const words = ['case', 'echo', 'two', 'print', 'parenthesis', 'multi line', 'case', 'print', 'faster', 'agruments'];
    const question = [
        ".In PHP, keywords, functions, user-defined functions, and classes are not ____ - sensitive",
        "PHP ____ is not a function, it is a language construct",
        "How many ways are use to display output of PHP code?",
        "PHP _____ always returns 1",
        
        "If you want to display and use many parameters, you need to write them between ___________",
        "PHP echo can print _____-____ strings",
        "PHP echo is not strict with its letter ____",
        
        "This is also a statement, used as an alternative to echo at many times to display the output.",
        "Echo is ______ than print statement",
        "When using print, we cannot pass multiple _________"
    ]
