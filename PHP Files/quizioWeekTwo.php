...
<iframe width="841" height="473" src="https://www.youtube.com/embed/GNDWNW3IKwU?autoplay=1&loop=1" title="Cute Background Music No Copyright / Funny Background Music" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    ...
    <script>
        ...
        let questionList = [
            {
                question: ".JavaScript provides 3 places to put the JavaScript code:",
                a: "Head tag, within the body, tag and external tag",
                b: "Body tag, within head tag, external tag",
                c: "Body tag, within head tag, and external javascript file",
                d: "Body tag, end of head tag, and external java script file",
                level: "easy",
                answer: "Body tag, within head tag, and external JavaScript file"
            },
            {
                question: "An external JavaScript file must end with _____ extension.",
                a: ".js",
                b: ".javaS",
                c: ".script",
                d: ".s",
            ...
            {
                question: "It is represented by double forward slashes (//)",
                a: "Double Comment",
            ...
            {
                question: "How many ways of creating comments in JavaScript?",
                a: "One",
                b: "Two",
                c: "Three",
                d: "Four",
            ...
            {
                question: "It is represented by forward slash with asterisk then asterisk with forward slash (/**/).",
                a: "Double Comment",
                b: "Multi line comment",
                c: "Comment",
                d: "Single line comment",
            ...
            },
            {
                ...
                a: "Local variable and semi local variable",
                b: "Global variable and semi local variable",
                c: "Local variable and global variable",
                d: "Local variable and global script variable",
                level: "average",
                answer: "Local variable and global variable"
            },
            {
                question: "Variable ____ must start with a letter (a to z or A to Z), underscore( _ ), or dollar( $ ) sign",
                a: "Name",
                b: "Data type",
                c: "Data",
                d: "Value",
            ...
            {
                question: "const x and const X are the same",
                a: "True, because it is same letter",
                b: "True, because its both const",
                c: "False, because they have different letter case",
                d: "False, because there are no semi-colon",
                level: "hard",
                answer: "False, because they have different letter case"
            },
            {
                question: "A variable that is only declared inside block or function.",
                a: "Local variable",
                b: "Block variable",
                c: "Function variable",
                d: "Script variable",
            ...
            {
                question: "A data type in javascript that represents no value at all.",
                a: "Null",
                b: "Nothing",
                c: "Empty",
                d: "Zero",
