...
<script>
    ...
    const words = ['php', 'rasmus lerdorf', 'twelve', 'hypertext', 'november', 'html', 'interpreted', 'databases', 'data', 'pages'];
    const question = [
        "A programming language that si an open source, interpreted, and object-oriented scripting language that can be executed at the server-side.",
        "Who created PHP?",
        "How many features of PHP included in the module?",
        "PHP stands for _________ Preprocessor",
        
        "What month did the latest version of PHP was released?",
        "PHP code can be embedded into ____",
        "PHP is an ___________ language, i.e., there is no need for compilation",
        
        "PHP is a language that can store data into _________",
        "PHP can collect ____ from user inputs",
        "You can allow user some _____ of your website with PHP"
    ]
