...
<body>
    <div class="container">
        ...
        <iframe width="841" height="473" src="https://www.youtube.com/embed/GNDWNW3IKwU?autoplay=1" title="Cute Background Music No Copyright / Funny Background Music" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
<script>
    ...
    const words = ['three', 'extension', 'single line', 'multi line', 'script', 'src', 'data type', 'regexp', 'null', 'local'];
    const question = [
        "How many places or ways can you put your js code?",
        "What do you call this '.js' in every end of an external js files?",
        "What do you call a comment with 2 forward slashes (//)?",
        "What do you call a comment that uses forward slash and asterisk (/**/)",
        
        "Within what tags when you want to you js code between your body tag and head tag?",
        "Inside the script tags, what attribute should contain the file name of your external js file?",
        "It provides different data types to hold different types of values.",
        
        "What data type represents regular expression?",
        "It represents no value at all.",
        "A variable that only exists inside a block of code."
    ]
