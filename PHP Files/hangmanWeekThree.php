...
<script>
    ...
    const words = ['arithmetic', 'comparison', 'loop', 'if else', 'equal', 'increment', 'decrement', 'function', 'typeof', 'for'];
    const question = [
        "What operators will you use if you want to add, subtract, multiply or divide numbers?",
        "This operators comapares statements",
        "The JavaScript _____ are used to iterate the piece of code using for, while, do while or forin.",
        "The JavaScript _________ is used to execute the code whether condition is true or false.",
        
        "A symbol or sign that is used to assign values",
        "An arithmetic operator that always add 1 value to its original value",
        "An arithmetic operator that always subtract 1 value to its original value",
        
        "We call javascript _______ to call and reuse codes",
        "A special operator that check what is the data type of a variable",
        "A type of loop that itterates a specific number of times"
    ]
