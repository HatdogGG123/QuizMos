...
<script>
    ...
    const words = ['array', 'values', 'index', 'three', 'square', 'directly', 'constructor', 'comma', 'empty', 'new'];
    const question = [
        "It is an object that represents a collection of similar Type of elements.",
        "______ are contained inside an array.",
        "How can you access the elements inside an array?",
        "How many ways can we create arrays?",
        
        "What brackets should be used when creating arrays?",
        "A way of creating array where you first create an empty array and add elements one by one",
        "A way of creating array where you create instance of array by passing arguments",
        
        "We can use _____ to seperate different values.",
        "We should create first an _____ array when we are using Array Directly.",
        "To add an element inside the array, ee should use the ___ keyword."
    ]
