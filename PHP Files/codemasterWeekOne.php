...
<head>
    ...
    <title>Codemasters Week 1</title>
            ...
            <div class="computer-head">
                <div class="mainContent">
                    ...
                    <div class="quizBox">
                        ...
                        <div class="question">
                            <!-- Easy question -->
                            <p id="question1" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;document.write("This is a Website") <br>
                                &ensp;< /script>
                            </p>
                            <p id="question2" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;document.write(100) <br>
                                &ensp;< /script>
                            </p>
                            <p id="question3" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;document.write('Hello Javascript') <br>
                                &ensp;< /script>
                            </p>
                            <p id="question4" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;document.writeln("Goodbye World") <br>
                                &ensp;< /script>
                            </p>

                            <!-- Normal question -->
                            <p id="question5" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;var name = "Jobert"  <br>
                                    &ensp;&ensp;document.write(name + "Hello") <br>
                                &ensp;< /script>
                            </p>
                            <p id="question6" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;var name = "Jobert"  <br>
                                    &ensp;&ensp;document.write(name + "name") <br>
                                &ensp;< /script>
                            </p>
                            <p id="question7" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;var greeting = "Hello" <br>
                                    &ensp;&ensp;var name = "Alice" <br>
                                    &ensp;&ensp;document.write(greeting + ", " + name);<br>
                                &ensp;< /script>
                            </p>

                            <!-- Hard question -->
                            <p id="question8" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;document.write(3 + 3) <br>
                                &ensp;< /script>
                            </p>
                            <p id="question9" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;document.write("3" + "3") <br>
                                &ensp;< /script>
                            </p>
                            <p id="question10" style="display: none;">
                                &ensp;< script>  <br>
                                    &ensp;&ensp;document.write("3" + 3) <br>
                                &ensp;< /script>
                            </p>
